...
class Usuario(AbstractUser):
    ...
    # El campo avatar_image debe tener instaldo el  paquete Pillow
    avatar_image = models.ImageField(upload_to='usuarios/avatars/', verbose_name="Nombre archivo avatar", null=True, blank=True) 
    ...
    # Customer ID
    stripe_customer_id = models.CharField(max_length=255, verbose_name='ID de cliente en Stripe', null=True, blank=True)
